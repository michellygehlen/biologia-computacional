...
# CONFIGURAÇÕES
# =========================================================
#PRECISA REFAZER COM 6 MILHOES PQ EU SOBRESCREVI
#FEATURES_DIR = Path("saida_features_aa_dipep_v3_seed_6milhoes")
#OUTPUT_DIR = Path("saida_pca_classes_438")

FEATURES_DIR = Path("saida_features_aa_dipep_v3_seed")
OUTPUT_DIR = Path("saida_pca_classes_438_amostra")
...
def main() -> None:
    ...
    save_dataframe(mean_df, OUTPUT_DIR / "class_mean_vectors_438.csv")
    save_dataframe(min_df, OUTPUT_DIR / "class_min_vectors_438.csv")
    save_dataframe(max_df, OUTPUT_DIR / "class_max_vectors_438.csv")
    save_dataframe(summary_df, OUTPUT_DIR / "class_counts_438.csv")
    ...
    save_dataframe(pca_df, OUTPUT_DIR / "pca_of_class_means_438.csv")
    ...
    save_dataframe(explained_df, OUTPUT_DIR / "pca_explained_variance_438.csv")
    ...
    if coords.shape[1] >= 2:
        ...
        plt.title("PCA dos vetores médios das classes (438 features)")
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        plt.savefig(OUTPUT_DIR / "pca_of_class_means_438_2d.png", dpi=200)
        plt.close()
    ...
    print("  - class_mean_vectors_438.csv")
    print("  - class_min_vectors_438.csv")
    print("  - class_max_vectors_438.csv")
    print("  - class_counts_438.csv")
    print("  - pca_of_class_means_438.csv")
    print("  - pca_explained_variance_438.csv")
    print("  - pca_of_class_means_438_2d.png")
    print("  - metadata.json")
