...
FEATURES_DIR = Path("saida_features_600_comparacao")
OUTPUT_DIR = Path("saida_pca_classes_600_amostra")
...
def main() -> None:
    ...
    for cls in classes:
        ...
        # carrega só as linhas da classe
    ...
    save_dataframe(mean_df, OUTPUT_DIR / "class_mean_vectors_600.csv")
    save_dataframe(min_df, OUTPUT_DIR / "class_min_vectors_600.csv")
    save_dataframe(max_df, OUTPUT_DIR / "class_max_vectors_600.csv")
    save_dataframe(summary_df, OUTPUT_DIR / "class_counts_600.csv")
    ...
    save_dataframe(pca_df, OUTPUT_DIR / "pca_of_class_means_600.csv")
    ...
    save_dataframe(explained_df, OUTPUT_DIR / "pca_explained_variance_600.csv")
    ...
    if coords.shape[1] >= 2:
        ...
        plt.title("PCA dos vetores médios das classes (600 features)")
        plt.grid(True, alpha=0.3)
        plt.tight_layout()
        plt.savefig(OUTPUT_DIR / "pca_of_class_means_600_2d.png", dpi=200)
        plt.close()
    ...
    metadata = {
        ...
        "feature_name_pattern": "F000 ... F599",
    }
    ...
    print("  - class_mean_vectors_600.csv")
    print("  - class_min_vectors_600.csv")
    print("  - class_max_vectors_600.csv")
    print("  - class_counts_600.csv")
    print("  - pca_of_class_means_600.csv")
    print("  - pca_explained_variance_600.csv")
    print("  - pca_of_class_means_600_2d.png")
    print("  - metadata.json")
